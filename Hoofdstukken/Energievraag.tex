\chapter{Energievraag van het schip}
\label{ch:energievraag}
\label{ch:holtrop-aandrijflijn}

\noindent Dit hoofdstuk bepaalt de \emph{energievraag} van \emph{'t~Jansje}: het
benodigde aandrijfvermogen en de daaruit volgende energiebehoefte aan boord. Deze
grootheden vormen de invoer voor de latere keuze van het energieopslagsysteem
(Hoofdstuk~\ref{ch:energiekeuze}); dit hoofdstuk levert dus invoer en beantwoordt
zelf nog geen deelvraag.

\noindent Eerst wordt de scheepsweerstand geschat via de Holtrop-Mennen methode en
wordt de volledige aandrijflijn doorgerekend naar het minimaal te installeren
motorvermogen. Vervolgens wordt op basis van het operationeel profiel en de hotel
load de totale energiebalans, inclusief reserves, bepaald.
...
Voor de berekeningen van de aandrijflijn en energieopslag wordt \textbf{7~knopen}
...
% --- Subsectie "Validatie en beperkingen" verplaatst naar het hoofdstuk Discussie ---
% (label subsec:holtrop-validatie verhuist mee; zie Discussie.tex)
