...
berekening gebruikt dezelfde wandverticale benadering als hierboven
($A_{WP} = 77{,}0\ \mathrm{m^2}$ en $I_T = 101{,}1\ \mathrm{m^4}$ constant),
zoetwater ($\rho = 1000\ \mathrm{kg/m^3}$), een vrijboordmarge van
$0{,}20$~m en een zwaartepunt van de toegevoegde lading op
$z_\mathrm{lad} = 1{,}20$~m boven kiel.
...
werkelijke batterijlading van $3{,}6$~t valt een factor $\approx 7{,}5$ onder
dit maximum.
