...
\section*{Beschikbaar volume voor energieopslagsysteem}
...
\end{enumerate}
Brandveiligheidseisen (bron verwijzing naar casper), daarvoor moeten systemen zoals batterijen thermisch geisoleerd zijn van de warmtebronnen (moto/uitlaat).\\
Bereikbaar voor onderhoud \\
Water bij een systeem is ongewenst voor de veiligheid door bijvoorbeeld kortsluiting, corrosie en slijtage.\\
Lage GM betekent dat het energieopslagsysteem niet te hoog moeten zijn om het schip instabiel te maken.
\subsection*{Beschikbare ruimtes}
...
\end{figure}
\newpage
\noindent Nu worden de ruimtes getoetst aan de eerder gestelde eisen.\\
\\
De Bridge en Woon ruimte zijn essentieel voor de eigenaar en vallen af (eis 1).\\
Het dek is niet geschikt omdat deze niet tegen regen beschermt (eis 2).\\
Volgens \ref{} voldoet de machinekamer niet aan moderne brandveiligheidsseisen eis(3).\\
...
\midrule
1. Ruimte is niet essentieel voor eigenaar & \checkmark & \checkmark & $\times$   & \checkmark & $\times$   \\
\addlinespace
...
\end{tabular}
\end{table}
\noindent Dit geeft de volgende schematische weergave:
\begin{figure}[H]
    \centering
    ...
    \label{fig:Afvallers}
\end{figure}
\noindent Oftewel alleen de opslagruimte is als enige een optie voor de opslag van batterijen. Deze opslagruimte heeft een volume van 12 $m^3$ en zal dus als beschikbare ruimte worden gezien \cite{vanbaalen2026interview}.
